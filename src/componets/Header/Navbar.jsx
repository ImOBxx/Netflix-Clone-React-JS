  ...
  return (
    <Fade>
      <header
        className={
          props.playPage
            ? "fixed top-0 z-10 w-full backdrop-sm"
            : "fixed top-0 z-10 w-full"
        }
      >
        <nav
          className={`transition duration-500 ease-in-out bg-gradient-to-b from-black to-gray-401 ${
            show && "transition duration-500 ease-in-out bg-gradient-to-b from-black to-gray-1000"
          }`}
        >
