  ...
  return (
    ...
    >
      ...
      {movies[0] ? (
        <>
          <h1
            className="text-white mb-0 font-bold text-base sm:text-xl md:text-1xl" // Removed margin-bottom
            style={{ marginBottom: '4px' }} // Inline style for tighter spacing
           >
            {props.title}
            </h1>
          ...
          <Swiper
            ...
            breakpoints={{
              1800: { slidesPerView: 8.2, spaceBetween: 2 },
              1280: { slidesPerView: 4.3, spaceBetween: 8 },
            }}
                    ...
                    <Fade bottom duration={300}>
                      <div className="flex transition ml-3 ease-in-out delay-150">
                        <div
                          ...
                          className="text-white w-9 h-9 border-[2px] rounded-full p-2 mr-1 backdrop-blur-[1px] hover:border-red-500 hover:text-red-500 hover:bg-transparent ease-linear transition-all duration-150"
                        >
                          <svg
